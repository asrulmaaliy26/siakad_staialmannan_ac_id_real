                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <?php
                                            echo cmb_dinamis('status_mhs', 'ref_option', 'opt_val', 'opt_id', null, null, 'id="status_mhs"  style="width: 100%;" onchange="reload_table()"', null, null, ['opt_group' => 'status_mhs', 'is_aktif !=' => 'N']);
                                        ?>
                                    </div>
                                </div>
                    ...
                    <table id="data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Syarat KRS</th>
                                <th class="text-center">Publikasi</th>
                                <th class="text-center">Syarat UTS</th>
                                <th class="text-center">Syarat UAS</th>
    ...
    table = $('#data').DataTable({
        ...
        "ajax": {
            ...
            "data": function(data) {
                ...
                data.status_mhs = $('#status_mhs').val();
            }
        },
        "columnDefs": [{
            "targets": [],
...
function reset(id, nama) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url("akademik/$controller/reset");?>",
                type: "post",
                data: "id=" + id,
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (data.msg == "success") {
                        Swal.fire({
                            icon: data.msg,
                            title: 'KRS '+nama+' berhasil direset',
                            allowOutsideClick: false,
                        }).then(() => {
                            reload_table();
                        });
