        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a role="button" class="btn btn-primary btn-sm" title="Update Jadwal" data-palcement="top"  href="javascript:void(0)" data-toggle="modal" data-target="#updateJadwalModal">
                        <i class="fa fa-sync"></i> Update Jadwal By Excel
                    </a>
...
<div class="modal fade" id="updateJadwalModal" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <form class="form-horizontal" id="form_update_jadwal" enctype="multipart/form-data">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Update Jadwal</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="file_xls">Pilih
                                            file</label>
                                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="prosesUpdateJadwal()">Simpan </button>
            </div>
        </form>
    </div>
</div>
                    ...
                    success: function(data) {
                        ...
                        if (data.msg == 'success') {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        url: "<?php echo site_url("akademik/$controller/tetapsimpanJadwal");?>",
                                        type: "post",
                                        data: {id_distribusi_mk:list, dosen:dosen, H_Jadwal:H_Jadwal, jam:jam, ruang_kuliah:ruang_kuliah, pelaksanaan_kuliah:pelaksanaan_kuliah, kd_tahun:kd_tahun},
                                        dataType: 'json',
                                        beforeSend: function() {
...
function prosesUpdateJadwal() {
        //var form = $('#form_simpan');
        var data = new FormData($("#form_update_jadwal")[0]);
        $('#form_update_jadwal').find('.invalid-feedback').text('');
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url("akademik/$controller/updateJadwalExcel"); ?>",
                    type: "post",
                    data: data,
                    processData: false,
                    contentType: false,
