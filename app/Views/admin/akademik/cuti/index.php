    ...
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
                ...
                <a role="button" class="btn btn-primary btn-sm" title="Formulir Cuti" data-palcement="top"  href="javascript:void(0)" onclick="formulir()">
                    <i class="fa fa-sync"></i> Formulir
                </a>
                <!--
...
function hapus(id, param) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "Permohonan cuti "+ param+" akan dihapus?",
        icon: 'warning',
...
function activate(id, nama) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "Mengubah status permohonan cuti "+nama+"!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
function formulir() {
    var kd_ta = $('#tahun_akademik option:selected').val();
    var link = "<?=base_url("akademik/$controller/formulir?kd_ta=")?>"+kd_ta;
    var iframe = '<object type="text/html" data="'+link+'" frameborder="0" scrolling="yes" seamless="seamless" style="display:block; width:100%; height:100vh;">No Support</object>';
    if(kd_ta == ''){
        Swal.fire({
            icon: 'warning',
...
function cetak(id) {
    var link = "<?=site_url("akademik/$controller/cetak?id=")?>"+id;
    Swal.fire({
        title: 'Are you sure?',
        text: "Mencetak formulir permohonan cuti?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
