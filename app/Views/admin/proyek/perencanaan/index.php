                            	...
                            	<div class="form-group">
		                            ...
		                            <div class="input-group ">
		                                ...
		                                <div class="input-group-append">
		                                    ...
		                                    <!--
		                                    <a role="button" class="btn btn-success" title="Tambah Proyek" data-palcement="top"  href="javascript:void(0)" data-toggle="modal" data-target="#tambahModal">
        	...
        	<table id="data" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="col-2 text-center align-middle">Nama Proyek</th>
                        <th class="col-1 text-center align-middle">Tahun Anggaran</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle"><?=$value['nama_proyek'];?></td>
                        <td class="text-center align-middle"><?=$value['tahun_anggaran'];?></td>
                        <td class="text-center align-middle">
                            <!--<a href="javascript:void(0)" role="button" class="btn btn-xs btn-warning" data-placement="top" title="Edit" onclick="edit(<?=$value['id_proyek'];?>)"><i class="fa fa-edit"></i></a>-->
                            <a href="<?=site_url()?>/proyek/perencanaan/rincian?id=<?=urlencode(base64_encode($value['id_proyek']))?>" role="button" class="btn btn-xs btn-primary" data-placement="top" title="Detail"><i class="fa fa-eye"></i></a>
                            <!--<a onclick="hapus(<?=$value['id_proyek'];?>)" role="button" role="button" class="btn btn-xs btn-danger" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></a>-->
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <form class="form-horizontal" id="form_group" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control summernote" rows="10" id="deskripsi" name="deskripsi">
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.msg) {
                ...
                $('#exampleModalLabelEdit').text('Edit Data Proyek');
