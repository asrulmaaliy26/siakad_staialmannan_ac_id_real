    ...
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
                ...
                <button type="button" onclick="formulir()" class="btn btn-info float-right">Formulir Disposisi</button>
                <?php } ?>
            </div>
        </div>
        <div class="card card-primary card-outline">
...
function hapus(id_disposisi, param) {
    
    Swal.fire({
        title: 'Are you sure?',
        text: "Disposisi "+ param+" akan dihapus?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url("tugasakhir/$controller");?>",
                type: "post",
                data: "aksi=hapus&id=" + id_disposisi,
                dataType: 'json',
                beforeSend: function() {
                    Swal.fire({
                        title: 'Please Wait!!',
                ...
                success: function(data) {
                    ...
                    if (data.status) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Disposisi '+ param+' berhasil dihapus',
                            allowOutsideClick: false,
                        }).then(() => {
...
function cetak(id_disposisi) {
    var link = "<?=site_url("tugasakhir/$controller/cetak?id_disposisi=")?>"+id_disposisi;
    Swal.fire({
        title: 'Are you sure?',
        text: "Mencetak disposisi?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url("tugasakhir/$controller/getData");?>",
                type: "post",
                data: {
                    id: id_disposisi
                },
...
function formulir(id_his_pdk) {
    ...
    $.createModal({
      title:'Fomurlir Disposisi Skripsi',
      message: iframe,
      closeButton:true,
      table_reload:true,
      scrollable:false
