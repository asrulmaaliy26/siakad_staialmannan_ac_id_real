                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-responsive-sm">
                        <form class="form-horizontal" id="form_kualifikasi" enctype="multipart/form-data">
    	                    <table class="table table-sm">
    	                    	<tr>
    		                        <td style="width:20%">Full Text</td>
    		                        <td>
    		                            <?php
            ...
            $.ajax({
                ...
                error: function(xhr, ajaxOptions, thrownError) {
                	...
                	let pesanError = '';
                            ...
                            let errorThrown = thrownError || '';
    
                            switch (status) {
                              case 0:
                                  pesanError = 'Tidak dapat terhubung ke server. Silakan periksa koneksi internet Anda.';
                                  break;
                              case 404:
                                  pesanError = 'Halaman atau data yang diminta tidak ditemukan (404).';
                                  break;
                              case 401:
                                  pesanError = 'Sesi login Anda telah berakhir. Silakan login ulang untuk melanjutkan.';
                                  break;
                              case 500:
                                  pesanError = 'Terjadi kesalahan pada server. Silakan hubungi teknisi jika masalah berlanjut.';
                                  break;
                              default:
                                  pesanError = `Terjadi kesalahan yang tidak dikenali. (Kode: ${status})`;
                                  break;
                            }
                            ...
                            Swal.fire({
                              ...
                              html: `
                                  <b>Status:</b> ${status} - ${statusText}<br>
                                  <b>Pesan:</b> ${pesanError}<br>
                                  <b>Detail Teknis:</b> ${errorThrown}<br>
                                  <pre style="max-height:200px;overflow:auto;font-size:12px;background:#f8f8f8;border:1px solid #ddd;padding:10px;">${responseText}</pre>
                              `,
