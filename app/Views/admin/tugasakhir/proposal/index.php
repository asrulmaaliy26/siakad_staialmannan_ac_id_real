                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <?php
                                            echo cmb_dinamis('status', 'ref_option', 'opt_val', 'opt_id', null, null, 'id="status"  style="width: 100%;" onchange="reload_table()"', null, null, ['opt_group' => 'status_proposal', 'is_aktif !=' => 'N']);
                                        ?>
                                    </div>
                                </div>
...
function hapus(id, param) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "Data Proposal "+ param+" akan dihapus?",
        icon: 'warning',
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Data Proposal '+ param+' berhasil dihapus',
                            allowOutsideClick: false,
                        }).then(() => {
...
function ekspor() {
	...
	if(list.length>0)
	{
		...
		Swal.fire({
            title: 'Are you sure?',
            text: "Mengunduh data "+list.length+" Siswa ??",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
	...
	else
	{
		Swal.fire({
			title: "Ooooppsss....!",
			text: "Pilih siswa yang akan diekspor!!",
			icon: "error",
			allowOutsideClick: false
		});
	}
