									...
									<tr>
										...
										<td>
										    ...
										    <?php
                                                ...
                                                echo cmb_dinamis('status', 'ref_option', 'opt_val', 'opt_id', ((isset($status))?$status:NULL), 'form-control-sm', 'id="status"  style="width: 100%;"', null, null, ['opt_group' => 'status_ijazah', 'is_aktif !=' => 'N']);     
