            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#dokumen" onclick="loadDokumen()" data-toggle="tab">Dokumen</a></li>
                  ...
                  <div class="tab-pane" id="dokumen">
                        <div class="mailbox-controls">
                              <div class="row">
                                    ...
                                    <div class="btn-group">
                                      <a href="<?=base_url("$controller/tmb_dokumen?kd_dosen=$Kode")?>" judul="Tambah dokumen" tabel="dokumen" role="button" class="btn btn-success btn-sm tambah" data-placement="top" title="Tambah dokumen">
...
$(function() {
    ...
    $(document).ready(function(){
        ...
        button.setAttribute('href', 'https://api.whatsapp.com/send?text='+encodeURIComponent(text+link_ref));
...
function loadDokumen(){
    ...
    $('#data_dokumen').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url("$controller/loadDokumen") ?>",
            "type": "POST",
            "data": function(data) {
                data.kd_dosen = kd_dosen;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    Swal.fire({
                        ...
                        if(b.reload_table===true && b.tbl === 'dokumen'){
                            loadDokumen();
                        }
