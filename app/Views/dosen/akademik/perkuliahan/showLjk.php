        ...
        <div class="container-fluid">
                        ...
                        <div class="col-sm-6">
                            <div class="table-responsive">
                                <table class="table table-sm">
                                  ...
                                  <tr>
                                    <th >Prodi</th>
                                    <td>: <?=getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Prodi']?> - <?=getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Program']?> - <?=getDataRow('histori_pddk', ['id_his_pdk' => $id_his_pdk])['Kelas']?></td>
                                  </tr>
                                  
                                  <tr>
                                    <th>Tgl. Upload</th>
                                    <td>: <?=($ujian == 'uas')?tgl_indonesia($tgl_upload_ljk_uas):tgl_indonesia($tgl_upload_ljk_uts)?></td>
                                  </tr>
                                </table>
                            </div>
                        </div>
            ...
            <?php if($jns_soal == '1'){?>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <iframe src="<?=str_replace( 'http://', 'https://',$dt_artikel['file_artikel'])?>" style="width: 100%; height: 400px;" frameborder="0"></iframe>
                    </div>
                </div>
