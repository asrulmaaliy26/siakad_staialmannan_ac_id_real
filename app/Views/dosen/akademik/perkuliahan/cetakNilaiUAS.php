...
<div style="text-align: center;">
	ABSENSI PESERTA<br>UJIAN AKHIR SEMESTER (UAS) <?=getDataRow('tahun_akademik', ['kode'=>$data['kd_tahun_mk']])['semester'] == '1'?'GASAL':'GENAP';?><br>STAI AL-MANNAN TULUNGAGUNG<br>TAHUN AKADEMIK <?=getDataRow('tahun_akademik', ['kode'=>$data['kd_tahun_mk']])['tahunAkademik'];?>
	<br><br>
</div>
<?php
...
<div>
	<table border="0" style="font-size: 11pt;">
		...
		<tr>
			...
			<td>Hari/Tanggal</td>
			<td>: <?=$mk['Hari'];?> / <?=date_indo($mk['Tgl']."-".$mk['Bln']."-".$mk['Thn']);?></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
...
<div>
	<table width="100%" style="border-collapse: collapse; font-size: 9pt;">
		...
		<tr>
			...
			<td style="border: 1px solid black; text-align: center;"><?=$list['Nilai_TGS']=='' | 0.00?'':number_format($list['Nilai_TGS'],2);?></td>
			<td style="border: 1px solid black; text-align: center;"><?=$list['Nilai_UAS']=='' | 0.00?'':number_format($list['Nilai_UAS'],2);?></td>
			<td style="border: 1px solid black; text-align: center;"><?=$list['Nilai_Performance']=='' | 0.00?'':number_format($list['Nilai_Performance'],2);?></td>
			<td style="border: 1px solid black; text-align: center; font-size: 8pt;">
			    <?
			        if($list['Nilai_Performance']!=0){
