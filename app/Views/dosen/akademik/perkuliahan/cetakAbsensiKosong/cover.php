...
<br>
<div
	style=" width: 30%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; padding-left: 20mm;">
	MATA KULIAH</div>
<div style=" width: 5%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">:</div>
<div style=" width: 55%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">
	<?= strtoupper($mk['Mata_Kuliah']) ?>
</div>
<div
	style=" width: 30%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; padding-left: 20mm;">
...
<div style=" width: 5%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">:</div>
<div style=" width: 55%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">
	<?= getDataRow('data_dosen', ['Kode' => $mk['Kd_Dosen']])['Nama_Dosen']; ?>
</div>
<div
	style=" width: 30%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; padding-left: 20mm;">
	SEMESTER / KET</div>
<div style=" width: 5%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">:</div>
<div style=" width: 55%; float: left; font-family: 'Arial Bold', sans-serif; font-size:16px; font-weight:bold; ">SMT
	<?= $mk['SMT'] ?> / <?= $mk['Kelas'] ?>
</div>
<br>
<br>
