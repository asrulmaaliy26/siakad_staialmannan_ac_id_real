                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    <th>Nama Dosen</th>
                                    <td>:
                                        <?= getDataRow('data_dosen', ['Kode' => $perkuliahan['Kd_Dosen']])['Nama_Dosen'] ?>
                                    </td>
                                </tr>

                                <tr>
                                    <th>Jadwal</th>
                                    <td>: <?= $perkuliahan['H_Jadwal'] ?> Jam <?= $perkuliahan['Jam_Jadwal'] ?> Ruang
                                        <?= $perkuliahan['R_Jadwal'] ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    <th>Pelaksanaan</th>
                                    <td>:
                                        <?= (!empty($perkuliahan['Pelaksanaan'])) ? getDataRow('ref_option', ['opt_group' => 'pelaksanaan_kuliah', 'opt_id' => $perkuliahan['Pelaksanaan']])['opt_val'] : '-' ?>
                                    </td>
                                </tr>
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#absensi" onclick="getDataMhs()"
                            data-toggle="tab">Absensi</a></li>
                    <li class="nav-item"><a class="nav-link" href="#jurnal_pengajaran"
                            onclick="getJurnalKuliah('<?= $perkuliahan['kd_kelas_perkuliahan'] ?>')"
                            data-toggle="tab">Jurnal Pengajaran</a></li>
                    <li class="nav-item"><a class="nav-link" href="#dokumen_pengajaran"
                            onclick="getDokumen('<?= $perkuliahan['kd_kelas_perkuliahan'] ?>')" data-toggle="tab">Dokumen
                            Perkuliahan</a></li>
                    <li class="nav-item"><a class="nav-link" href="#ujian"
                            onclick="getSoal('<?= $perkuliahan['kd_kelas_perkuliahan'] ?>')" data-toggle="tab">Ujian</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#penilaian"
                            onclick="getDataNilai('<?= $perkuliahan['kd_kelas_perkuliahan'] ?>')"
            ...
            <div class="card-body">
                <div class="tab-content">
                        ...
                        <div class="mailbox-controls">
                            ...
                            <div class="card">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="prodi" id="prodi" class="form-control select2"
                                                            onchange="getDataMhs()" style="width: 100%;">
                                                            <option></option>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a role="button" class="btn btn-success btn-sm show_modal"
                                        href="<?= base_url("akademik/$controller/absensiMhs?kd_kelas_perkuliahan=") . $perkuliahan['kd_kelas_perkuliahan'] ?>"
                                        tabel="absensi_mahasiswa" judul_modal="Absensi Perkuliahan Mahasiswa">
                                        Absensi
                                    </a>

                                    <button type="button" class="btn btn-success btn-sm" data-placement="top"
                                        title="Tambah Mahasiswa" onclick="cetakAbsensiKosong()">
                                        Cetak Absensi Kosong
                                    </button>
                                    <button type="button" class="btn btn-success btn-sm" data-placement="top"
                                        title="Pilih Kosma"
                                        onclick="pilihKosma('<?= $perkuliahan['kd_kelas_perkuliahan'] ?>')">
                                        Pilih Kosma
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="jurnal_pengajaran">
                        <div class="mailbox-controls">
                            <a role="button" class="btn btn-success btn-sm show_modal"
                                href="<?= base_url("akademik/$controller/tambahJurnal?kd_kelas_perkuliahan=") . $perkuliahan['kd_kelas_perkuliahan'] ?>"
                                tabel="jurnal" judul_modal="Tambah Jurnal Perkuliahan">
                    ...
                    <div class="tab-pane" id="dokumen_pengajaran">
                        <div class="mailbox-controls">
                            <a role="button" class="btn btn-success btn-sm show_modal"
                                href="<?= base_url("akademik/$controller/tambahDokumen?kd_kelas_perkuliahan=") . $perkuliahan['kd_kelas_perkuliahan'] ?>"
                                tabel="dokumen" judul_modal="Upload Dokumen Perkuliahan">
                                Upload File
                            </a>
                        </div>
                        <div class="table-responsive">
                    ...
                    <div class="tab-pane" id="ujian">
                        <div class="mailbox-controls">
                            <a role="button" class="btn btn-success btn-sm show_modal"
                                href="<?= base_url("akademik/$controller/tambahSoal?kd_kelas_perkuliahan=") . $perkuliahan['kd_kelas_perkuliahan'] ?>"
                                tabel="soal" judul_modal="Upload Soal Ujian">
                        ...
                        <div class="mailbox-controls">
                            <div class="card">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Program Studi</label>
                                                        <select name="prodi_nilai" id="prodi_nilai"
                                                            class="form-control select2" onchange="getDataNilai()"
                                                            style="width: 100%;">
                                                            <option></option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Kelas</label>
                                                        <select name="kelas_nilai" id="kelas_nilai"
                                                            class="form-control select2" onchange="getDataNilai()"
                                                            style="width: 100%;">
                                                            <option></option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ujian_nilai" id="ujian_nilai"
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="button" class="btn btn-success btn-sm" data-placement="top"
                                        title="Download nilai prodi" onclick="cetakNilaiProdi()">
                                        Download Nilai Prodi
                                    </button>
                                    <button type="button" class="btn btn-primary btn-sm" data-placement="top"
                                        title="Sinkronkan Nilai" onclick="getDataNilai()">
                                        Sinkronkan Nilai
                                    </button>
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            Swal.close();
                            if (data.status) {
                                halaman = window.open(link_cetak_absen_kosong, "_blank");
                                return false;
                            } else {
                                Swal.fire({
                                    icon: 'error',
