                    ...
                    <form class="form-horizontal" id="form_tambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group row " hidden>
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="id_dokumen" name="id_dokumen" value="<?=(isset($id_dokumen))?$id_dokumen:''?>" />
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="judul_dokumen" name="judul_dokumen" value="<?=(isset($judul_dokumen))?$judul_dokumen:''?>" />
                                <div class="invalid-feedback">
...
function simpan() {
    ...
    Swal.fire({
        title: 'Anda yakin akan menyimpan data dokumen ??',
