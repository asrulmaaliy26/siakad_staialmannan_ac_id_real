            ...
            <div class="row">
                <section class="col-md-7">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body"> 
                            <iframe src="https://view.officeapps.live.com/op/embed.aspx?src=<?=getDataRow('munaqasyah_skripsi', ['id_munaqasyah' => $id])[$field]?>" frameborder="0" scrolling="yes" seamless="seamless" style="display:block; width:100%; height:100vh;"></iframe>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body"> 
                            <form id="form_komentar" enctype="multipart/form-data">
                                <input type="text" class="form-control" value="<?=$id?>" hidden name="id_munaqasyah" id="id_munaqasyah">
                                ...
                                <textarea class="form-control artikel" rows="10" id="komentar" name="komentar"><?=(!empty(getDataRow('hasil_skripsi', ['id_munaqasyah' => $id, 'penguji' => $tugas])))?getDataRow('hasil_skripsi', ['id_munaqasyah' => $id, 'penguji' => $tugas])[$field]:''?></textarea>
                            </form>
                        </div>
