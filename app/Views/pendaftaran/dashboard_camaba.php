                                        ...
                                        <div class="col-sm-6 pr-2">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label">NISN <small><em>(Jika
                                                            ada)</em></small></label>
                                                    <input type="text" class="form-control" id="NISN" name="NISN" value="<?=(!empty($data_diri))?$data_diri['NISN']:''?>"/>
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label">Jenis Asal Sekolah<code>*</code></label>
                                                    <select name="Jenis_SLTA" id="Jenis_SLTA" class="form-control select2" style="width:100%;">
                                                        <<option value="">  </option>
            												<option value="MA" <?=(!empty($data_diri) && $data_diri['Jenis_SLTA'] == 'MA')?'selected':''?>> MA </option>
            												<option value="SMA" <?=(!empty($data_diri) && $data_diri['Jenis_SLTA'] == 'SMA')?'selected':''?>> SMA </option>
            												<option value="SMK" <?=(!empty($data_diri) && $data_diri['Jenis_SLTA'] == 'SMK')?'selected':''?>> SMK </option>
            												<option value="Paket C" <?=(!empty($data_diri) && $data_diri['Jenis_SLTA'] == 'Paket C')?'selected':''?>> Paket C </option>
            												<option value="Madrasah Diniyyah Kesetaraan" <?=(!empty($data_diri) && $data_diri['Jenis_SLTA'] == 'Madrasah Diniyyah Kesetaraan')?'selected':''?>> Madrasah Diniyyah Kesetaraan </option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6 pl-2">
                                            <div class="form-group">
            					                ...
            					                <input type="text" class="form-control" id="Alamat_Lengkap_Sekolah_Asal" name="Alamat_Lengkap_Sekolah_Asal" value="<?=(!empty($data_diri))?$data_diri['Alamat_Lengkap_Sekolah_Asal']:''?>"/> 
            					                <div class="invalid-feedback"></div>
            					            </div>
            					            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label">No. Seri Ijazah SLTA</label>
                                                    <input type="text" class="form-control" id="No_Seri_Ijazah_SLTA" name="No_Seri_Ijazah_SLTA" value="<?=(!empty($data_diri))?$data_diri['No_Seri_Ijazah_SLTA']:''?>"/>
...
function simpan() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url("pendaftaran/updateS1");?>",
                type: "post",
                data: data,
                dataType: 'json',
                beforeSend: function() {
