      ...
      <div class="bs-stepper-content">
        <form id="form_disposisi" class="needs-validation" onSubmit="return false" novalidate enctype="multipart/form-data">
          ...
          <div id="file-upload-part" class="bs-stepper-pane fade" role="tabpanel" aria-labelledby="file-upload-part-trigger">
            ...
            <div class="form-group row">
              <label for="plagiasi" class="col-md-6">Surat Keterangan Bebas Plagiasi (PDF)</label>
              <div class="col-md-6">
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="plagiasi" name="plagiasi">
                    <label class="custom-file-label" for="plagiasi">Choose file</label>
                  </div>
   ...
   $('#judul-part-inp').summernote({
    ...
    callbacks: {
      onPaste: function(e) {
        ...
        Swal.fire({
         title: "Ooooppsss....!",
         text: "Mohon maaf, tidak diperbolehkan copy paste. Silahkan ketik pada tempat yang disediakan",
         icon: "error",
       });
      },
      ...
      $.ajax({
        ...
        success: function(data) {
         ...
         if (data.session_expired) {
                      // Jika sesi habis, arahkan kembali ke base_url
                      Swal.fire({
                        icon: 'error',
                        title: 'Ooops!!! Sesion Anda telah berakhir. Silahkan login lagi.',
                        confirmButtonText: 'OK',
                        allowOutsideClick: false,
                      }).then(() => {
                          window.location.href = baseUrl; // Ganti dengan URL base Anda
                        })
