    	                ...
    	                <tbody>
    	                    <tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=kwitansi_pendaftaran"?>" judul_modal="Upload Kwitansi Pendaftaran" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
    						...
    						<tr>
								...
								<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bebas_bak"?>" judul_modal="Upload Surat Keterangan Bebas BAK" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=ktm"?>" judul_modal="Upload Kartu Tanda Mahasiswa" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=khs"?>" judul_modal="Upload Kartu Hasil Studi (KHS)" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=kartu_bimbingan"?>" judul_modal="Upload Kartu Bimbingan" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
								...
								<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=persetujuan_munaqasyah"?>" judul_modal="Upload Nota Persetujuan Munaqasyah" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=posmaru"?>" judul_modal="Upload Sertifikat PBAK" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
								...
								<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=sertifikat_kkn"?>" judul_modal="Upload Sertifikat KKN" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=ppl"?>" judul_modal="Upload Sertifikat PPL" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=sertifikat_seminar"?>" judul_modal="Upload Sertifikat Seminar 3 jenis kegiatan" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=plagiasi"?>" judul_modal="Upload Surat Keterangan Bebas Plagiasi" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=toefl_toafl"?>" judul_modal="Upload Sertifikat TOEFL / TOAFL" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=kuesioner"?>" judul_modal="Upload Angket kuesioner monitoring bimbingan tugas akhir" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=powerpoint"?>" judul_modal="File Powerpoint Presentasi" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
								...
								<td class="text-center align-middle">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=skripsi"?>" judul_modal="Upload File Skripsi Hasil Cek Plagiasi LPJI" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
                    ...
                    <div class="table-responsive">
    	                ...
    	                <thead>
    		                <tr>
    		                    ...
    		                    <th class="text-center align-middle">Komentar Penguji</th>
    	                ...
    	                <tbody>
    	                    ...
    	                    <tr>
    							...
    							<td>
    							    ...
    							    <?php if(!empty($komen1['bag_depan']) || !empty($komen2['bag_depan']) || !empty($komen3['bag_depan'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bag_depan">
                                              ...
                                              <?php if(!empty($komen1['bag_depan']) && $status > 4){?>
                                              ...
                                              <?php if(!empty($komen2['bag_depan'])  && $status > 4){?>
                                              ...
                                              <?php if(!empty($komen3['bag_depan'])  && $status > 4){?>
    							...
    							<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bag_depan"?>" judul_modal="Upload Halaman Depan (Cover, Motto, Daftar isi, dll.)" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
    						...
    						<tr>
    							...
    							<td>
								    ...
								    <?php if(!empty($komen1['bab1']) || !empty($komen2['bab1']) || !empty($komen3['bab1'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab1">
                                              ...
                                              <?php if(!empty($komen1['bab1'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab1'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab1'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
							    ...
							    <td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab1"?>" judul_modal="Upload BAB I" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['bab2']) || !empty($komen2['bab2']) || !empty($komen3['bab2'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab2">
                                              ...
                                              <?php if(!empty($komen1['bab2'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab2'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab2'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab2"?>" judul_modal="Upload BAB II" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['bab3']) || !empty($komen2['bab3']) || !empty($komen3['bab3'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab3">
                                              ...
                                              <?php if(!empty($komen1['bab3'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab3'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab3'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab3"?>" judul_modal="Upload BAB III" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['bab4']) || !empty($komen2['bab4']) || !empty($komen3['bab4'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab4">
                                              ...
                                              <?php if(!empty($komen1['bab4'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab4'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab4'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab4"?>" judul_modal="Upload BAB IV" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['bab5']) || !empty($komen2['bab5']) || !empty($komen3['bab5'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab5">
                                              ...
                                              <?php if(!empty($komen1['bab5'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab5'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab5'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab5"?>" judul_modal="Upload BAB V" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['bab6']) || !empty($komen2['bab6']) || !empty($komen3['bab6'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_bab6">
                                              ...
                                              <?php if(!empty($komen1['bab6'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['bab6'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['bab6'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=bab6"?>" judul_modal="Upload BAB VI" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['pustaka']) || !empty($komen2['pustaka']) || !empty($komen3['pustaka'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_pustaka">
                                              ...
                                              <?php if(!empty($komen1['pustaka'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['pustaka'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['pustaka'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=pustaka"?>" judul_modal="Upload Daftar Pustaka" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
							...
							<tr>
    							...
    							<td>
								    <?php if(!empty($komen1['lampiran']) || !empty($komen2['lampiran']) || !empty($komen3['lampiran'])){ ?>
                                        ...
                                        <div class="col-12" id="komen_lampiran">
                                              ...
                                              <?php if(!empty($komen1['lampiran'])  && $status > 4){?>
                                              <b class="d-block">Penguji 1</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen2['lampiran'])  && $status > 4){?>
                                              <b class="d-block">Penguji 2</b>
                                              <div class="post clearfix">
                                              ...
                                              <?php if(!empty($komen3['lampiran'])  && $status > 4){?>
                                              <b class="d-block">Sekretaris</b>
                                              <div class="post clearfix">
								...
								<td class="text-center">
    								...
    								<a href="<?=base_url("tugasakhir/$controller/uploadUlang?id_munaqasyah=").$id_munaqasyah."&field=lampiran"?>" judul_modal="Upload Lampiran-lampiran" class="btn btn-xs btn-primary show_modal" data-placement="top" title="Upload Ulang"><i class="fas fa-upload"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                          <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" onclick="unggah('revisi','<?=$id_munaqasyah?>','Revisi Skripsi'); return false;" class="btn btn-sm btn-primary"><b>Upload</b></a>
                            </td>
                            <td>
                                <?php if(!empty($revisi) ){?>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" onclick="unggah('pengesahan_revisi','<?=$id_munaqasyah?>','Pengesahan Revisi Skripsi'); return false;" class="btn btn-sm btn-primary"><b>Upload</b></a>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                                <input type="text" id="link_jurnal" name="link_jurnal" onfocusout="simpan_catatan('link_jurnal','<?=$id_munaqasyah;?>')" class="form-control" value="<?=$link_jurnal;?>" />
                            </td>
                          </tr>
            ...
            <form class="form-horizontal" id="form_upload" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row " hidden>
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  id="id_munaqasyah" name="id_munaqasyah" />
...
function unggah(field, id_munaqasyah, nm_berkas) {
    ...
    $('#uploadModal').on('show.bs.modal', function () {
        ...
        $(this).find('#id_munaqasyah').val(id_munaqasyah);
