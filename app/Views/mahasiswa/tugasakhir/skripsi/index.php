    ...
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
                <button type="button" onclick="formulir('<?=$id_his_pdk?>')" class="btn btn-info btn-sm float-right">Formulir Munaqasyah Skripsi</button>
                <a href="<?=base_url('assets/template/Angket_Kuisioner_Tugas_Akhir_IAIBAFA.docx');?>" target="_blank" role="button" class="btn btn-info btn-sm float-right" > Template Kuesioner</a>
            </div>
        </div>
        <div class="card card-primary card-outline">
