	                    ...
	                    <div class="col-6">
	                    	<div class="table-responsive">
			                    <table class="table table-sm">
									...
									<tr>
										<th >Kelas</th>
										<td><?=(getDataRow('db_data_diri_mahasiswa', ['id' => $id_data_diri])['kelas'] == "PA") ? "Putera" : ((getDataRow('db_data_diri_mahasiswa', ['id' => $id_data_diri])['kelas'] == "PI") ? "Puteri" : getDataRow('db_data_diri_mahasiswa', ['id' => $id_data_diri])['kelas']);?></td>
									</tr>
									<tr>
										<th>Program</th>
