                ...
                <div class="mailbox-controls">
                    <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="prodi" id="prodi" class="form-control select2" disabled style="width: 100%;">
                                                        <option></option>
                                                        ...
                                                        <?php $prodi = dataDinamis('mata_kuliah', ['kd_kelas_perkuliahan' => $perkuliahan['kd_kelas_perkuliahan']], null, 'Prodi', null,null, null, 'Prodi'); 
                                                            ...
                                                            foreach ($prodi as $key ) {
                                                        ?>
                                                        <option value="<?=$key->Prodi?>" <?=getDataRow('histori_pddk', ['id_his_pdk'=>$id_his_pdk])['Prodi']==$key->Prodi?'selected':''?>><?=$key->Prodi?></option>
                                                        <?php    }    ?>
                                                    </select>
                                                </div>
                                            </div>
                                        	<div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Kelas</label>
                                                    <select name="kelas" id="kelas" class="form-control select2" disabled style="width: 100%;">
                                                        <option></option>
                                                        ...
                                                        <?php $kelas = dataDinamis('mata_kuliah', ['kd_kelas_perkuliahan' => $perkuliahan['kd_kelas_perkuliahan']], null, 'Kelas', null,null, null, 'Kelas'); 
                                                            ...
                                                            foreach ($kelas as $key ) {
                                                        ?>
                                                        <option value="<?=$key->Kelas?>" <?=getDataRow('db_data_diri_mahasiswa', ['id'=>$id_data_diri])['kelas']==$key->Kelas?'selected':''?>><?=$key->Kelas?></option>
                                                        <?php    }    ?>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                                if(!empty(getDataRow('tb_kosma_kelas_perkuliahan', ['kd_kelas_perkuliahan' => $perkuliahan['kd_kelas_perkuliahan'], 'id_his_pdk' => $id_his_pdk]))){
                            ?>
...
function getDokumen(){
    $('#data_dokumen').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url("akademik/$controller/listDokumenPerkuliahanMahasiswa") ?>",
                "type": "POST",
                "data": function(data) {
                    data.kd_kelas_perkuliahan = '<?=$perkuliahan['kd_kelas_perkuliahan']?>';
                }
...
function ubah_status(id_file) {
    Swal.fire({
        title: 'Ubah Status Dokumen?',
        text: "Status dokumen akan diubah (aktif <-> nonaktif)",
        icon: 'question',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?=site_url("akademik/$controller/tambahDokumen");?>", // sama seperti hapus_file()
                type: "post",
                data: "aksi=ubah_status&id=" + id_file,
                dataType: "json",
                beforeSend: function() {
                    Swal.fire({
                        title: 'Memproses...',
