  ...
  <div class="textarea">
    ...
    <div style="text-align: justify;">
      Dengan ini, Kami Tim Penguji menerangkan bahwa pada hari ini, <?=(!empty($data['skripsi']['tgl_sidang']))?tgl_indonesia_date($data['skripsi']['tgl_sidang']):'';?> bertempat di Ruang Sidang Institut Agama Islam Bani Fattah Jombang, telah dilaksanakan Sidang Munaqasyah Skripsi dengan mahasiswa yang diuji:
    </div>
    ...
    <div style="width: 100%;">
      ...
      <div class="kolom2">:</div>
      <div class="kolom3"><div><?=strtoupper(strip_tags($data['skripsi']['judul_skripsi']));?></div></div>
    </div>
