...
<div class="text_area">
	...
	<div style="border:0.2mm dashed #220044; padding: 0.2cm;">
		...
		<div style="width: 25%; float: left; ">
			Program <br>Pilihan Prodi 1 <br>Pilihan Prodi 2
		</div>
		<div style="width: 20%; float: left; ">
			 : <?=$data['pmb']['Kelas_Program_Kuliah'];?> <br>: <?=$data['pmb']['Prodi_Pilihan_1'];?><br>: <?=$data['pmb']['Prodi_Pilihan_2'];?>
		</div>
	</div>
	...
	<table width="100%" border="0" style="vertical-align: text-top;" >
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td width="1%">&nbsp;</td>
	      <td width="16%">NISN</td>
	      <td colspan="2">: <?=$data['diri']['NISN'];?></td>
	    </tr>
	    <tr>
	      <td>NIK</td>
	    ...
	    <tr>
	      <td colspan="7"><strong>Identitas Sekolah :</strong></td>
	      </tr>
	    <tr>
	    ...
	    <tr>
	      <td>Jenis Sekolah</td>
	      <td colspan="2">: <?=$data['diri']['Jenis_SLTA'];?></td>
	      <td>&nbsp;</td>
	      <td>Tahun Lulus</td>
	    ...
	    <tr>
	      ...
	      <td colspan="2">: <?=$data['diri']['No_Seri_Ijazah_SLTA'];?></td>
	    </tr>
	    <tr>
	      <td>Alamat Sekolah</td>
	      <td colspan="6">: <?=$data['diri']['Alamat_Lengkap_Sekolah_Asal'];?></td>
	      </tr>
	    <tr>
	...
	<div class="foto">
		<img src="http://akademik.iaibafa.ac.id/pendaftaran/foto/<?=$data['pmb']['Nama_File_Foto'];?>"  alt="">
	</div>
	<div class="berkas">
