                    ...
                    <div class="table-responsive">
                        <table class="table">
                          ...
                          <tr>
                            ...
                            <td>
                                <?=
                                    (!empty(getDataRow('penguji_sempro', ['id_sempro' => $id, 'tugas' => 1])))?getDataRow('data_dosen', ['Kode' => getDataRow('penguji_sempro', ['id_sempro' => $id, 'tugas' => 1])['kd_dosen']])['Nama_Dosen']:'';
                                ?>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                                <?=
                                    (!empty(getDataRow('penguji_sempro', ['id_sempro' => $id, 'tugas' => 2])))?getDataRow('data_dosen', ['Kode' => getDataRow('penguji_sempro', ['id_sempro' => $id, 'tugas' => 2])['kd_dosen']])['Nama_Dosen']:'';
                                ?>
                            </td>
                          </tr>
                        </table>
