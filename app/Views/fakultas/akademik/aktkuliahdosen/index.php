...
function cetakPdf(){
    ...
    var fakultas = "<?=getDataRow('auth_groups_users', ['group_id' => session()->get('akun_level_id'), 'user_id' => session()->get('akun_id')])['bagian']?>";
    var link_cetak = "<?=site_url("akademik/$controller/cetakRekap?tahun_akademik=")?>"+tahun_akademik+"&tgl_awal="+tgl_awal+"&tgl_akhir="+tgl_akhir+"&fakultas="+fakultas
    Swal.fire({
