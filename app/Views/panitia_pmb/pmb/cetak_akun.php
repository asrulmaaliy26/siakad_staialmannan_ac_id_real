...
<div class="kotak_kartu">
    <div ><strong>KARTU AKUN</strong><br><strong>SIM STAI AL-MANNAN</strong></div>
    <?
        if(getDataRow('users', ['username'=>$data['username']])['foto_profil']==NULL || getDataRow('users', ['username'=>$data['username']])['foto_profil']==''){
            ...
            $foto = base_url()."/".getDataRow('users', ['username'=>$data['username']])['foto_profil'];
        }
    ...
    <div class="text_area" id="outer">
        <div>
            <ul>
                ...
                <li>SIM STAI Al-Mannan dapat diakses melalui laman <strong><?=base_url()?></strong></li>
                <li>User ID dan Password hanya bisa digunakan di SIM STAI Al-Mannan.</li>
                <li>SIM STAI Al-Mannan digunakan untuk menangani proses pengelolaan data akademik seperti KRS, KHS, Ujian dan data terkait lainnya.</li>
