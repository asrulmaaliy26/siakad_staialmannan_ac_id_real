    ...
    $('#data').DataTable({
        ...
        "ajax": {
            ...
            "data": function(data) {
                ...
                data.prodi = "<?=getDataRow('auth_groups_users', ['group_id' => session()->get('akun_level_id'), 'user_id' => session()->get('akun_id')])['bagian']?>";
            }
        },
        "columnDefs": [{
            "targets": [],
...
function cetakPdf(){
    ...
    var prodi = "<?=getDataRow('auth_groups_users', ['group_id' => session()->get('akun_level_id'), 'user_id' => session()->get('akun_id')])['bagian']?>";
    var link_cetak = "<?=site_url("akademik/$controller/cetakRekap?tahun_akademik=")?>"+tahun_akademik+"&tgl_awal="+tgl_awal+"&tgl_akhir="+tgl_akhir+"&prodi="+prodi
    Swal.fire({
