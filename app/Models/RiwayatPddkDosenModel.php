...
class RiwayatPddkDosenModel extends Model
{
    ...
    protected $allowedFields    = ['jenjang', 'nama_pendidikan', 'gelar_pendidikan', 'th_lulus', 'id_staff'];
    ...
    protected $column_order = ['th_lulus'];
    protected $column_search = ['jenjang'];
    protected $order = ['th_lulus' => 'ASC'];
    protected $request;
    protected $dt;
    ...
    public function simpanData($record)
    {
        ...
        if (isset($record['id_riwayat_pendidikan'])) {
            //Update data 
            $builder->save($record);
            return true;
        } else {
