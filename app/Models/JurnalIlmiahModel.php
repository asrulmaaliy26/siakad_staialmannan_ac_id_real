...
class JurnalIlmiahModel extends Model
{
    ...
    protected $allowedFields    = ['id_artikel', 'judul_artikel', 'nama_jurnal', 'tahun_artikel', 'volume', 'issn', 'link', 'id_staff'];
    ...
    protected $column_order = ['tahun_artikel'];
    protected $column_search = ['judul_artikel'];
    protected $order = ['tahun_artikel' => 'DESC'];
    protected $request;
    protected $dt;
