...
class DokumenDosenModel extends Model
{
    ...
    protected $allowedFields    = ['judul_dokumen', 'id_staff', 'lokasi_file'];
    ...
    protected $column_order = ['judul_dokumen'];
    protected $column_search = ['judul_dokumen'];
    protected $order = ['judul_dokumen' => 'DESC'];
    protected $request;
    protected $dt;
