...
class BukuDosenModel extends Model
{
    ...
    protected $allowedFields    = ['judul_buku', 'tahun_buku', 'isbn', 'penerbit', 'id_staff', 'link_isbn'];
    ...
    protected $column_order = ['tahun_buku'];
    protected $column_search = ['judul_buku'];
    protected $order = ['tahun_buku' => 'DESC'];
    protected $request;
    protected $dt;
