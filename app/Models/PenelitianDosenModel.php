...
class PenelitianDosenModel extends Model
{
    ...
    protected $allowedFields    = ['Judul_penelitian', 'th_penelitian', 'dana_penelitian', 'tingkat_penelitian', 'id_staff', 'lokasi_file'];
    ...
    protected $column_order = ['th_penelitian'];
    protected $column_search = ['Judul_penelitian'];
    protected $order = ['th_penelitian' => 'DESC'];
    protected $request;
    protected $dt;
